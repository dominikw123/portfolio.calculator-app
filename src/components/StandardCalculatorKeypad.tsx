...
export default function StandardCalculatorKeypad() {
  return (
    <div className="grid grid-cols-4 grid-rows-5 gap-3">
      ...
      <CalculatorButton onClick={() => console.log("·")}>·</CalculatorButton>
      <CalculatorButton className="bg-green-100 border-green-300 text-green-500 hover:bg-green-200 hover:border-green-400 hover:text-green-600" onClick={() => console.log("=")}>=</CalculatorButton>
    </div>
  );
}